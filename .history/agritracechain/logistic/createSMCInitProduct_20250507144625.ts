...
export async function SMCProduct(
    walletA: any,
    data: string,
    price: number,
    next_handler: string,
...
async function main() {
    ...
    const data = "asjdhaksdhiashdiahsdiuashiduhaskjdha";
    const price = 200;
    const next_handler = "addr_test1qqwkave5e46pelgysvg6mx0st5zhte7gn79srscs8wv2qp5qkfvca3f7kpx3v3rssm4j97f63v5whrj8yvsx6dac9xrqyqqef6";
