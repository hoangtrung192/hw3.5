...
function getAddressUTXOAsset(address, unit) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, blockchainProvider.fetchAddressUTxOs(address, unit)];
                case 1:
                    utxos = _a.sent();
                    if (utxos.length === 0)
...
function updateTokens(params) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, utxos, walletAddress, collateral, userPubKeyHash, exChange, pubkeyExchange, unsignedTx, mintCompilecode, storeCompilecode, storeScriptCbor, storeScript, storeAddress, storeScriptHash, mintScriptCbor, policyId, completedTx, signedTx, txHashUpdate;
        var _this = this;
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 1:
                                            _b = _c.sent();
                                            return [3 /*break*/, 4];
                                        case 2: return [4 /*yield*/, getAddressUTXOAsset(storeAddress, policyId + core_1.CIP68_100(core_1.stringToHex(assetName)))];
                                        case 3:
                                            _b = _c.sent();
                                            _c.label = 4;
                                        case 4:
                                            ...
                                            unsignedTx
                                                ...
                                                .txOut(storeAddress, [
                                                {
                                                    unit: policyId + core_1.CIP68_100(core_1.stringToHex(assetName)),
                                                    quantity: "1"
                                                }
                                            ])
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, utxos, walletAddress, collateral, userPubKeyHash, exChange, pubkeyExchange, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error("Error updating tokens:", error_1);
                    return [3 /*break*/, 4];
