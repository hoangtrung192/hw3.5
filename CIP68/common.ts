...
export const blockchainProvider = new BlockfrostProvider('preprodv2dpc8lwWCGVEMwTPPAvNGiwtB0d0n5F');
...
export const wallet = new MeshWallet({
  ...
  key: {
    ...
    words: [
      "six", "setup", "chapter", "parent", "secret", "spring", "slide", "frost", "violin", "high", "leader", "volcano", "whale", "lady", "waste", "again", "swarm", "antique", "design", "mean", "mistake", "permit", "elephant", "predict"
