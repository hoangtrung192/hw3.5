...
async function main(){
  const txHash1 = "e3284c12fc41adfe0f1791366c1c75f7486931cdae024180114a8d8a3a1c98af";
  const txHash2 = "663f412279f67b284ddd8ebc15c5c6df6cba36618aa1eebb45d4b1360e9bdbad";
  ...
  await exportMoney([txHash1, txHash2], amount, scriptAddr, constributeScriptCbor, addrReceiver, admin);
}
main();