...
exports.shopperGetMoney = void 0;
var core_1 = require("@meshsdk/core");
var general_ts_1 = require("../general.ts");
function shopperGetMoney(walletB, txHash) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, utxos, walletAddress, collateral, pubKeyBuyer, txBuilder, scriptUtxo, compileCode, scriptCbor, scriptAddr, tx, txId;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, general_ts_1.getWalletInfoForTx(walletB)];
                case 1:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, txBuilder
                            ...
                            .txInRedeemerValue(core_1.mConStr0([core_1.stringToHex("getPaid")]))
                ...
                case 5:
                    txId = _b.sent();
                    console.log("Transaction Build Successfully !, txID: ", txId);
                    return [2 /*return*/];
            }
        });
    });
}
exports.shopperGetMoney = shopperGetMoney;
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var wallet, txHash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wallet = general_ts_1.walletB;
                    txHash = "351f58c3c259566d17b5339d531128dab88831c88b4161b7982b2ad6577f3f15";
                    return [4 /*yield*/, shopperGetMoney(wallet, txHash)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
