...
async function main(){
    ...
    const next_handler = "addr_test1qz5x
    5e46pelgysvg6mx0st5zhte7gn79srscs8wv2qp5qkfvca3f7kpx3v3rssm4j97f63v5whrj8yvsx6dac9xrqyqqef6"; // địa chỉ người xử lí tiếp theo
}